            ...
            <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
                <div className="max-w-2xl mx-auto lg:mx-0">
                    ...
                    <p className="mt-4 text-zinc-400">
                        From concept to deployment, explore my development projects that address real-world needs with elegance and efficiency.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 mx-auto lg:grid-cols-2">
                    ...
                    <div>
                        <Link href="https://plug.army">
                            <div className="relative overflow-hidden rounded-2xl w-full h-[30rem] transition-transform ease-in-out duration-500 hover:scale-95">
                                <Image width={592} height={480} src="/plug_mockups.webp" className="overflow-hidden transition-transform ease-in-out duration-500 hover:scale-110 object-cover w-full h-full" alt="Plug™ App" />
                            </div>
                    ...
                    <div>
                        <Link href="https://spotilabs.fr">
                            <div className="relative overflow-hidden rounded-2xl w-full h-[30rem] transition-transform ease-in-out duration-500 hover:scale-95">
                                <Image width={592} height={480} src="/spotilabs_mockup.webp" className="overflow-hidden transition-transform ease-in-out duration-500 hover:scale-110 object-cover w-full h-full" alt="Spotilabs Website" />
                            </div>
                            <div className="flex flex-col justify-center items-center mt-4">
